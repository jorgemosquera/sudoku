...
${OBJECTDIR}/gridFunctions.o: gridFunctions.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gridFunctions.o gridFunctions.c
...
${OBJECTDIR}/oldFunctions.o: oldFunctions.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/oldFunctions.o oldFunctions.c
